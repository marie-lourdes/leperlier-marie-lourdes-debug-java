...
/**
* the class Main execute a program that get list of symptoms from a file symptoms.txt , count the number of occurrences; finally write and save in other file result.out in alphabetical order
